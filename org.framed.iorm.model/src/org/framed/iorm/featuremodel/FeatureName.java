 ...
 * <!-- end-user-doc -->
 * @see org.framed.iorm.featuremodel.FeaturemodelPackage#getFeatureName()
 * @model
 * @generated
 */
public enum FeatureName implements Enumerator {
	 ...
	 * @ordered
	 */
	INTRA_RELATIONSHIP_CONSTRAINTS(24, "Intra_Relationship_Constraints", "Intra_Relationship_Constraints"),
	 ...
	 * @ordered
	 */
	INTER_RELATIONSHIP_CONSTRAINTS(26, "Inter_Relationship_Constraints", "Inter_Relationship_Constraints"),
	 ...
	 * @ordered
	 */
	PLAYABLE_BY_DEFINING_COMPARTMENT(34, "Playable_by_Defining_Compartment", "Playable_by_Defining_Compartment"),
	 ...
	 * @generated
	 */
	private static final FeatureName[] VALUES_ARRAY = new FeatureName[] { RML_FEATURE_MODEL, ROLE_TYPES, ROLE_STRUCTURE,
			ROLE_PROPERTIES, ROLE_BEHAVIOR, ROLE_INHERITANCE, PLAYABLE, PLAYERS, NATURALS, ROLES, COMPARTMENTS, DATES,
			DEPENDENT, ON_COMPARTMENTS, ON_RELATIONSHIPS, ROLE_CONSTRAINTS, ROLE_IMPLICATION, ROLE_PROHIBITION,
			ROLE_EQUIVALENCE, GROUP_CONSTRAINTS, OCCURRENCE_CONSTRAINTS, RELATIONSHIPS, RELATIONSHIP_CONSTRAINTS,
			RELATIONSHIP_CARDINALITY, INTRA_RELATIONSHIP_CONSTRAINTS, PARTHOOD_CONSTRAINTS,
			INTER_RELATIONSHIP_CONSTRAINTS, COMPARTMENT_TYPES, COMPARTMENT_STRUCTURE, COMPARTMENT_PROPERTIES,
			COMPARTMENT_BEHAVIOR, COMPARTMENT_INHERITANCE, PARTICIPANTS, CONTAINS_COMPARTMENTS,
	 ...
	 * @generated
	 */
	public static final List<FeatureName> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
