...
/**
 * This is the item provider adapter for a {@link org.framed.iorm.model.ModelElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelElementItemProvider extends NamedElementItemProvider {
	...
	protected void addIncomingRelationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ModelElement_incomingRelations_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ModelElement_incomingRelations_feature",
								"_UI_ModelElement_type"),
						OrmPackage.Literals.MODEL_ELEMENT__INCOMING_RELATIONS, true, false, true, null, null, null));
	}
	...
	protected void addOutgoingRelationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ModelElement_outgoingRelations_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ModelElement_outgoingRelations_feature",
								"_UI_ModelElement_type"),
						OrmPackage.Literals.MODEL_ELEMENT__OUTGOING_RELATIONS, true, false, true, null, null, null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ModelElement_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ModelElement_type_feature",
								"_UI_ModelElement_type"),
						OrmPackage.Literals.MODEL_ELEMENT__TYPE, true, false, false,
