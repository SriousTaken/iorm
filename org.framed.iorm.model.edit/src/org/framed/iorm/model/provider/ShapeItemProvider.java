...
/**
 * This is the item provider adapter for a {@link org.framed.iorm.model.Shape} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ShapeItemProvider extends ModelElementItemProvider {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(OrmPackage.Literals.SHAPE__FIRST_SEGMENT, OrmFactory.eINSTANCE.createSegment()));

		newChildDescriptors.add(
				createChildParameter(OrmPackage.Literals.SHAPE__SECOND_SEGMENT, OrmFactory.eINSTANCE.createSegment()));

		newChildDescriptors
				.add(createChildParameter(OrmPackage.Literals.SHAPE__MODEL, OrmFactory.eINSTANCE.createModel()));
		...
		newChildDescriptors.add(
				createChildParameter(OrmPackage.Literals.SHAPE__DESCRIPTION, OrmFactory.eINSTANCE.createRelation()));

		newChildDescriptors
				.add(createChildParameter(OrmPackage.Literals.SHAPE__DESCRIPTION, OrmFactory.eINSTANCE.createShape()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == OrmPackage.Literals.SHAPE__FIRST_SEGMENT
