/**
 */
package org.framed.iorm.model.provider;
...
/**
 * This is the item provider adapter for a {@link org.framed.iorm.model.Relation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationItemProvider extends ModelElementItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Relation_target_feature",
								"_UI_Relation_type"),
						OrmPackage.Literals.RELATION__TARGET, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Relation_source_feature",
								"_UI_Relation_type"),
						OrmPackage.Literals.RELATION__SOURCE, true, false, true, null, null, null));
	}
	...
	protected void addReferencedRelationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Relation_referencedRelation_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Relation_referencedRelation_feature",
								"_UI_Relation_type"),
						OrmPackage.Literals.RELATION__REFERENCED_RELATION, true, false, true, null, null, null));
	}
	...
	protected void addReferencedRolesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Relation_referencedRoles_feature"),
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(OrmPackage.Literals.RELATION__SOURCE_LABEL,
		...
		newChildDescriptors.add(
				createChildParameter(OrmPackage.Literals.RELATION__SOURCE_LABEL, OrmFactory.eINSTANCE.createShape()));

		newChildDescriptors.add(createChildParameter(OrmPackage.Literals.RELATION__TARGET_LABEL,
				OrmFactory.eINSTANCE.createNamedElement()));
		...
		newChildDescriptors.add(
				createChildParameter(OrmPackage.Literals.RELATION__TARGET_LABEL, OrmFactory.eINSTANCE.createShape()));
	}
