...
/**
 * This is the action bar contributor for the Orm model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrmActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	 ...
	 * @generated
	 */
	public OrmActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("orm-settings"));
		toolBarManager.add(new Separator("orm-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ORMEditorPlugin.INSTANCE.getString("_UI_OrmEditor_menu"),
				"org.framed.iorm.modelMenuID");
